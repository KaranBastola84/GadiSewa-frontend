...
const Button = ({
  ...
  const baseStyles =
    "relative flex items-center justify-center px-6 py-3.5 rounded-md font-bold transition-all duration-200 active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed text-sm uppercase tracking-widest";
